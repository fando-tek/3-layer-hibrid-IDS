...
class Model:
    def __init__(self):
        ...
        #normalisasi = joblib.load("H:\\3_hibrid_learning\\normalisasi_minmaxScaler_rasio_4_1.joblib")
        ...
        #tambah_fitur = ['dst_port', 'protocol', 'timestamp']
        #fitur_dihapus_1 = [*fitur_dihapus_1['0'].values.tolist(), *tambah_fitur]
        #fitur_dihapus_2 = [*fitur_dihapus_2['0'].values.tolist(), *tambah_fitur]
        #fitur_dihapus_3 = [*fitur_dihapus_3['0'].values.tolist(), *tambah_fitur]

        # kolom dataset
        X_kolom = pd.read_csv("H:\\3_hibrid_learning\\3_hibrid_learning_ori\\rasio_4_1\\fitur\\fitur_rasio_4_1.txt")
        #X_kolom = pd.read_csv("H:\\3_hibrid_learning\\fitur_rasio_4_1.txt")
        ...
        #model_lapisan_1 = keras.models.load_model("H:\\3_hibrid_learning\\model_lstm_layer_1.joblib")
        ...
        #model_lapisan_2 = joblib.load("H:\\3_hibrid_learning\\model_rf_layer_2.joblib")
        print (" Selesai memuat ")
        ...
        #model_lapisan_3 = joblib.load("H:\\3_hibrid_learning\\model_rf_layer_3.joblib")
        print (" Selesai memuat ")
